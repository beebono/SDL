...
fn configHeader(b: *std.Build, t: std.Target) *std.Build.Step.ConfigHeader {
    ...
    return b.addConfigHeader(.{
        ...
        .SDL_AUDIO_DRIVER_PULSEAUDIO_DYNAMIC = 1,
        ...
        .SDL_VIDEO_DRIVER_KMSDRM_DYNAMIC = 1,
        .SDL_VIDEO_DRIVER_KMSDRM_DYNAMIC_GBM = 1,

        .SDL_VIDEO_DRIVER_WAYLAND_QT_TOUCH = 0,
        .SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC = 1,
        .SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_EGL = 1,
        .SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_CURSOR = 1,
        .SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_XKBCOMMON = 1,
        .SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_LIBDECOR = 1,

        .SDL_VIDEO_DRIVER_X11 = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XEXT = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XCURSOR = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XINPUT2 = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XFIXES = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XRANDR = 1,
        .SDL_VIDEO_DRIVER_X11_DYNAMIC_XSS = 1,
